    ...
    methods
        ...
        function obj = set_sens_HIGH1(obj)
                ...
                fprintf(obj.TPC_obj, ":SENSE:SENSE HIGH1");
                 ...
                 % We refresh
                obj.refresh_sensibility({"HIGH1",   obj.Sens_matr{ obj.findIndexInCell(obj.Sens_matr,"HIGH1") + 1}   });
        end
        ...
        function obj = set_sens_HIGH3(obj)
                ...
                % We refresh
                obj.refresh_sensibility({"HIGH3",   obj.Sens_matr{ obj.findIndexInCell(obj.Sens_matr,"HIGH3") + 1}   });
        end
        ...
        function obj = set_sens_RAPID1(obj)
                ...
                % We refresh
                obj.refresh_sensibility({"RAPID1",   obj.Sens_matr{ obj.findIndexInCell(obj.Sens_matr,"RAPID1") + 1}   });
        end
        ...
        function obj = set_sens_RAPID2(obj)
                ...
                % We refresh
                obj.refresh_sensibility({"RAPID2",   obj.Sens_matr{ obj.findIndexInCell(obj.Sens_matr,"RAPID2") + 1}   });
        end
        ...
        function obj = set_sens_RAPID3(obj)
                ...
                fprintf(obj.TPC_obj, ":SENSE:SENSE RAPID3");
                 ...
                 % We refresh
                obj.refresh_sensibility({"RAPID3",   obj.Sens_matr{ obj.findIndexInCell(obj.Sens_matr,"RAPID3") + 1}   });
        end
        ...
        function obj = set_sens_RAPID4(obj)
                ...
                % We refresh
                obj.refresh_sensibility({"RAPID4",   obj.Sens_matr{ obj.findIndexInCell(obj.Sens_matr,"RAPID4") + 1}   });
        end
        ...
        function obj = set_sens_RAPID5(obj)
                ...
                % We refresh
                obj.refresh_sensibility({"RAPID5",   obj.Sens_matr{ obj.findIndexInCell(obj.Sens_matr,"RAPID5") + 1}   });
        end
        ...
        function obj = set_sens_RAPID6(obj)
                ...
                % We refresh
                obj.refresh_sensibility({"RAPID6",   obj.Sens_matr{ obj.findIndexInCell(obj.Sens_matr,"RAPID6") + 1}   });
        end
        ...
        function obj = set_sweep_single(obj)
                ...
                % We refresh
                obj.refresh_SwMode({"SINGLE",   obj.Sweep_matr{ obj.findIndexInCell(obj.Sweep_matr,"SINGLE") + 1}   });
